...
namespace {
    ...
    void validate_config(const xayah::ClothConfig& config, const xayah::ClothSphereCollider& collider) {
...
namespace xayah {
    ...
    void ClothSolver::compute_normals() {
        ...
        xayah::cloth_cuda::launch_accumulate_normals(cloth_stream(this->device.stream), this->host.triangle_grid, this->host.block_size, this->device.position_x, this->device.position_y, this->device.position_z, this->device.normal_x, this->device.normal_y, this->device.normal_z, this->device.indices, this->device.error_flag, this->host.triangle_count);
        xayah::cloth_cuda::launch_normalize_normals(cloth_stream(this->device.stream), this->host.vertex_grid, this->host.block_size, this->device.normal_x, this->device.normal_y, this->device.normal_z, this->device.error_flag, this->host.vertex_count);
    }
