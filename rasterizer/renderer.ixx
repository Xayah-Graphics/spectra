...
namespace spectra::rasterizer {
    export struct alignas(16) RasterPrimitive {
    ...
    export struct alignas(16) RasterTransform {
    ...
    export struct alignas(16) RasterMaterial {
    ...
    export struct alignas(16) RasterTextureHeader {
        std::array<std::uint32_t, 4> metadata{};
        std::array<std::uint32_t, 2> program{};
        std::array<std::uint32_t, 2> reserved{};
    };

    export struct alignas(16) RasterTextureMapping {
        std::array<std::uint32_t, 4> metadata{};
        std::array<float, 4> transform_row_0{};
        std::array<float, 4> transform_row_1{};
        std::array<float, 4> transform_row_2{};
    ...
    export struct alignas(16) RasterConstantTexture {
        std::array<float, 4> value{};
    };

    export struct alignas(16) RasterImageTexture {
    ...
    export struct alignas(16) RasterCompositeTexture {
        std::array<std::uint32_t, 4> data{};
    };

    export struct alignas(16) RasterDirectionMixTexture {
        std::array<std::uint32_t, 4> data{};
        std::array<float, 4> direction{};
    };

    export struct alignas(16) RasterBilerpTexture {
        std::array<std::array<float, 4>, 4> values{};
        std::array<std::uint32_t, 4> data{};
    };

    export struct alignas(16) RasterAreaLight {
        std::array<float, 4> emission{};
    };

    export struct alignas(16) RasterSceneBindings {
    ...
    export struct alignas(16) GpuPickPrimitive {
        std::array<std::uint32_t, 4> metadata{};
    ...
    private:
        ...
        GpuDevice* gpu{};
        const render::GpuAssetCache* asset_cache{};
    ...
    public:
        const render::GpuAssetCache& assets;
        const DescriptorHandle& primitives_descriptor;
        const DescriptorHandle& transforms_descriptor;
        const DescriptorHandle& pick_primitives_descriptor;
        const DescriptorHandle& bindings_descriptor;
        scene::CameraResource& camera;
    };

    export struct Rasterizer {
        Rasterizer(GpuDevice& gpu, const RasterScene& scene, const std::filesystem::path& shader_directory);
        ~Rasterizer();
