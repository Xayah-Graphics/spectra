...
namespace spectra::rasterizer {
    ...
    public:
        ...
        Renderer(std::shared_ptr<scene::Scene> scene_instance, std::shared_ptr<scene::CameraWorkspace> camera_workspace);
        ~Renderer() noexcept;
    ...
    private:
        ...
        void connect_scene_host();
        void disconnect_scene_host() noexcept;
        ...
        void commit_viewport_camera_state(scene::ViewportCamera state);
        ...
        struct {
            ...
            scene::ViewportCamera camera_state{};
            ...
            bool camera_visual_axes_visible{false};
