...
module spectra.headless.output;
...
namespace spectra::headless {
    ...
    void record_linear_readback(runtime::VulkanRuntime& runtime, const vk::raii::CommandBuffer& command_buffer, const render::RenderOutput render_output, runtime::GpuBuffer& readback_buffer) {
    ...
    void record_display_readback(runtime::VulkanRuntime& runtime, const vk::raii::CommandBuffer& command_buffer, const runtime::GpuImage& image, const vk::ImageLayout image_layout, runtime::GpuBuffer& readback_buffer) {
    ...
    void write_gbuffer_exr(const std::filesystem::path& path, const render::RenderGBufferReadback& readback, const scene::SpectrumColorSpace color_space, const bool camera_space) {
