...
namespace spectra::runtime {
    ...
    VulkanDevice::VulkanDevice(VulkanInstance& instance, const vk::SurfaceKHR surface) : context{instance, surface} {
    ...
    void VulkanDevice::select_physical_device() {
        ...
        for (const vk::raii::PhysicalDevice& candidate : this->context.instance.instance.enumeratePhysicalDevices()) {
            ...
            const bool neural_field_combination                                                = std::ranges::any_of(cooperative_vector_properties, [](const vk::CooperativeVectorPropertiesNV& property) { return property.inputType == vk::ComponentTypeKHR::eFloat16 && property.inputInterpretation == vk::ComponentTypeKHR::eFloat16 && property.matrixInterpretation == vk::ComponentTypeKHR::eFloat16 && property.resultType == vk::ComponentTypeKHR::eFloat16; });
    ...
    void VulkanDevice::create_device() {
        ...
        if (this->ray_tracing_supported) {
            ...
            this->logical                                                                                            = vk::raii::Device{this->physical_device, vk::DeviceCreateInfo{{}, 1, &queue_create_info, 0, nullptr, static_cast<std::uint32_t>(enabled_extensions.size()), enabled_extensions.data(), nullptr, &features.get<vk::PhysicalDeviceFeatures2>()}};
        } else {
        ...
        this->queue = vk::raii::Queue{this->logical, this->queue_family_index, 0};
