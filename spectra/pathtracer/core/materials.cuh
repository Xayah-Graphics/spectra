...
namespace spectra {
    ...
    struct MaterialEvalContext : public TextureEvalContext {
        ...
        __host__ __device__ MaterialEvalContext(const SurfaceInteraction& si) : TextureEvalContext(si), wo(si.wo), ns(si.shading.n), dpdus(si.shading.dpdu) {}
    ...
    struct NormalBumpEvalContext {
        ...
        __host__ __device__ NormalBumpEvalContext(const SurfaceInteraction& si) : p(si.p()), uv(si.uv), n(si.n), dudx(si.dudx), dudy(si.dudy), dvdx(si.dvdx), dvdy(si.dvdy), dpdx(si.dpdx), dpdy(si.dpdy), faceIndex(si.faceIndex) {
        ...
        __host__ __device__ operator TextureEvalContext() const {
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ bool CanEvaluateTextures(TextureEvaluator texEval) const {
            return texEval.CanEvaluate({uRoughness, vRoughness}, {});
        }

        __host__ __device__ FloatTexture GetDisplacement() const {
            return displacement;
        }

        __host__ __device__ const Image* GetNormalMap() const {
            return normalMap;
        }
        ...
        template <typename TextureEvaluator>
        __host__ __device__ void GetBSSRDF(TextureEvaluator texEval, MaterialEvalContext ctx, SampledWavelengths& lambda) const {}

        __host__ __device__ static constexpr bool HasSubsurfaceScattering() {
            return false;
        }

        template <typename TextureEvaluator>
        __host__ __device__ DielectricBxDF GetBxDF(TextureEvaluator texEval, MaterialEvalContext ctx, SampledWavelengths& lambda) const {
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ ThinDielectricBxDF GetBxDF(TextureEvaluator texEval, MaterialEvalContext ctx, SampledWavelengths& lambda) const {
            // Compute index of refraction for dielectric material
            Float sampledEta = eta(lambda[0]);
            if (!eta.template Is<ConstantSpectrum>()) lambda.TerminateSecondary();
            // Handle edge case in case lambda[0] is beyond the wavelengths stored by the
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ Material ChooseMaterial(TextureEvaluator texEval, MaterialEvalContext ctx) const {
        ...
        __host__ __device__ Material GetMaterial(int i) const {
            return materials[i];
        }
        ...
        template <typename TextureEvaluator>
        __host__ __device__ void GetBxDF(TextureEvaluator texEval, MaterialEvalContext ctx, SampledWavelengths& lambda) const {
#if !defined(__CUDA_ARCH__)
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ HairBxDF GetBxDF(TextureEvaluator texEval, MaterialEvalContext ctx, SampledWavelengths& lambda) const {
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ DiffuseBxDF GetBxDF(TextureEvaluator texEval, MaterialEvalContext ctx, SampledWavelengths& lambda) const {
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ ConductorBxDF GetBxDF(TextureEvaluator texEval, MaterialEvalContext ctx, SampledWavelengths& lambda) const {
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ CoatedDiffuseBxDF GetBxDF(TextureEvaluator texEval, const MaterialEvalContext& ctx, SampledWavelengths& lambda) const;
        ...
        template <typename TextureEvaluator>
        __host__ __device__ void GetBSSRDF(TextureEvaluator texEval, const MaterialEvalContext& ctx, SampledWavelengths& lambda) const {}
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ CoatedConductorBxDF GetBxDF(TextureEvaluator texEval, const MaterialEvalContext& ctx, SampledWavelengths& lambda) const;
        ...
        template <typename TextureEvaluator>
        __host__ __device__ void GetBSSRDF(TextureEvaluator texEval, const MaterialEvalContext& ctx, SampledWavelengths& lambda, void*) const {}
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ DielectricBxDF GetBxDF(TextureEvaluator texEval, const MaterialEvalContext& ctx, SampledWavelengths& lambda) const {
        ...
        template <typename TextureEvaluator>
        __host__ __device__ TabulatedBSSRDF GetBSSRDF(TextureEvaluator texEval, const MaterialEvalContext& ctx, SampledWavelengths& lambda) const {
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ DiffuseTransmissionBxDF GetBxDF(TextureEvaluator texEval, MaterialEvalContext ctx, SampledWavelengths& lambda) const {
    ...
    public:
        ...
        template <typename TextureEvaluator>
        __host__ __device__ MeasuredBxDF GetBxDF(TextureEvaluator texEval, MaterialEvalContext ctx, SampledWavelengths& lambda) const {
    ...
    template <typename TextureEvaluator>
    __host__ __device__ inline bool Material::CanEvaluateTextures(TextureEvaluator texEval) const {
    ...
    __host__ __device__ inline FloatTexture Material::GetDisplacement() const {
        auto disp = [&](auto ptr) { return ptr->GetDisplacement(); };
        return Dispatch(disp);
    }

    __host__ __device__ inline const Image* Material::GetNormalMap() const {
