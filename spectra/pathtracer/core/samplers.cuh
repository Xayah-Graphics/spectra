...
#include <spectra/pathtracer/util/pmj02tables.cuh>
...
namespace spectra {
    ...
    private:
        ...
        __host__ __device__ Float SampleDimension(int dimension) const {
    ...
    public:
        ...
        __host__ __device__ void StartPixelSample(Point2i p, int index, int dim) {
            pixel       = p;
            sampleIndex = index;
            dimension   = dim;
        }
    ...
    private:
        ...
        __host__ __device__ Float SampleDimension(int dimension, uint32_t a, uint32_t hash) const {
            if (randomize == RandomizeStrategy::None)
    ...
    public:
        ...
        __host__ __device__ void StartPixelSample(Point2i p, int sampleIndex, int dimension) {
