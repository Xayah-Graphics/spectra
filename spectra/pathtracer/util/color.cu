...
namespace spectra
{
    ...
    void RGBToSpectrumTable::Init(Allocator alloc)
    {
        ...
        CoefficientArray* sRGBToSpectrumTableDataPtr =
            (CoefficientArray*)alloc.allocate_bytes(
        ...
        CoefficientArray* DCI_P3ToSpectrumTableDataPtr =
            (CoefficientArray*)alloc.allocate_bytes(
        ...
        CoefficientArray* REC2020ToSpectrumTableDataPtr =
            (CoefficientArray*)alloc.allocate_bytes(
        ...
        CoefficientArray* ACES2065_1ToSpectrumTableDataPtr =
            (CoefficientArray*)alloc.allocate_bytes(
    ...
    SPECTRA_CONST Float SRGBToLinearLUT[256] = {
