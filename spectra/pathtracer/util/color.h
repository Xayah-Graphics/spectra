...
namespace spectra
{
    ...
    {
        return RGB(spectra::Clamp(rgb.r, min, max), spectra::Clamp(rgb.g, min, max),
                   spectra::Clamp(rgb.b, min, max));
    }
    ...
    {
        return XYZ(spectra::Clamp(xyz.X, min, max), spectra::Clamp(xyz.Y, min, max),
                   spectra::Clamp(xyz.Z, min, max));
    }
