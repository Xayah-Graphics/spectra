...
namespace spectra
{
    ...
    public:
        ...
        SPECTRA_CPU_GPU T& operator()(int x, int y) { return (*this)[{x, y}]; }
        ...
        SPECTRA_CPU_GPU
        operator pstd::span<T>() { return pstd::span<T>(values, static_cast<size_t>(size())); }
        SPECTRA_CPU_GPU
    ...
    public:
        ...
        SPECTRA_CPU_GPU size_t BytesAllocated() const { return values.size() * sizeof(T); }
        SPECTRA_CPU_GPU int XSize() const { return nx; }
        SPECTRA_CPU_GPU int YSize() const { return ny; }
        SPECTRA_CPU_GPU int ZSize() const { return nz; }

        const_iterator begin() const { return values.begin(); }
        const_iterator end() const { return values.end(); }

        template <typename F>
        SPECTRA_CPU_GPU auto Lookup(Point3f p, F convert) const
        {
        ...
        template <typename F>
        SPECTRA_CPU_GPU auto Lookup(const Point3i& p, F convert) const
        {
