...
namespace spectra {
    ...
    public:
        ...
        SPECTRA_CPU_GPU T& operator()(int x, int y) {
            return (*this)[{x, y}];
        }
    ...
    public:
        ...
        SPECTRA_CPU_GPU size_t BytesAllocated() const {
            return values.size() * sizeof(T);
        }
        SPECTRA_CPU_GPU int XSize() const {
            return nx;
        }
        SPECTRA_CPU_GPU int YSize() const {
            return ny;
        }
        SPECTRA_CPU_GPU int ZSize() const {
            return nz;
        }
