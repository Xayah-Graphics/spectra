...
namespace spectra {
    ...
    SPECTRA_CPU_GPU inline bool Is8Bit(PixelFormat format) {
        return format == PixelFormat::U256;
    }

    SPECTRA_CPU_GPU inline bool Is16Bit(PixelFormat format) {
        return format == PixelFormat::Half;
    }

    SPECTRA_CPU_GPU inline bool Is32Bit(PixelFormat format) {
    ...
    SPECTRA_CPU_GPU inline bool RemapPixelCoords(Point2i* pp, Point2i resolution, WrapMode2D wrapMode);
