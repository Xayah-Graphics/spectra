...
namespace spectra {
    ...
    SPECTRA_CPU_GPU inline Vector3f Reflect(Vector3f wo, Vector3f n) {
        return -wo + 2 * Dot(wo, n) * n;
    }

    SPECTRA_CPU_GPU inline bool Refract(Vector3f wi, Normal3f n, Float eta, Float* etap, Vector3f* wt) {
    ...
    SPECTRA_CPU_GPU inline Float HenyeyGreenstein(Float cosTheta, Float g) {
    ...
    SPECTRA_CPU_GPU inline Float FrDielectric(Float cosTheta_i, Float eta) {
    ...
    SPECTRA_CPU_GPU inline Float FrComplex(Float cosTheta_i, pstd::complex<Float> eta) {
    ...
    SPECTRA_CPU_GPU inline SampledSpectrum FrComplex(Float cosTheta_i, SampledSpectrum eta, SampledSpectrum k) {
    ...
    public:
        ...
        SPECTRA_CPU_GPU inline Float D(Vector3f wm) const {
