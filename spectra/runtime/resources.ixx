...
namespace spectra {
    ...
    export struct GpuResources {
        ...
        [[nodiscard]] void* export_buffer_memory_handle(const GpuBuffer& buffer) const;
        [[nodiscard]] GpuExternalTimelineSemaphore create_external_simulation_timeline();
        [[nodiscard]] void* export_timeline_semaphore_handle(const GpuExternalTimelineSemaphore& timeline) const;
