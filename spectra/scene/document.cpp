...
namespace spectra {
    ...
    void SceneDocument::update_dynamic_setup(scene::Scene& target_scene, std::optional<scene::DynamicSetup> setup) {
        target_scene.dynamic_setup = std::move(setup);
