...
namespace spectra::dynamics {
    ...
    export struct ProviderDescriptor {
        ...
        std::vector<TelemetryValue> telemetry_descriptors{};
    };
    ...
    export struct DebugPrimitive {
        scene::DynamicSystemId system_id{};
    ...
    export struct SystemStatus {
        ...
        std::vector<ParameterDescriptor> parameters{};
        std::vector<TelemetryValue> telemetry_values{};
    };
...
namespace spectra {
    export struct DynamicWorld {
        ...
        void apply_parameter_changes(std::size_t system_index, bool reset);
        [[nodiscard]] std::vector<dynamics::SystemStatus>& system_statuses() noexcept;
        [[nodiscard]] std::span<const dynamics::ProviderDescriptor> available_providers() const noexcept;
        [[nodiscard]] const std::optional<scene::DynamicSetup>& setup() const noexcept;
        ...
        struct {
            ...
            std::vector<dynamics::SystemStatus> statuses{};
        } systems;
